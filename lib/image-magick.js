...
ImageMagick.prototype._downloadSource = function(source, target, callback) {
  exec(ImageMagick.Templates.get('downloadCmd', {source: source, target: target}), callback)
}
...
ImageMagick.prototype._getMimeType = function(file, callback) {
  exec(ImageMagick.Templates.get('identifyCmd', { file: file }), function(_, stdout, _) {
