var exec      = require('child_process').exec
  ...
  , userAgent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.30 (KHTML, like Gecko) Chrome/26.0.1405.0 Safari/537.30'
...
ImageMagick.Templates = {
  ...
  downloadCmd: "curl -A " + userAgent + " --create-dirs -sf '%{source}' -o '%{target}'",
